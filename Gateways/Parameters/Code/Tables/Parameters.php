...
namespace Finance\Gateways\Parameters\Code\Tables;
 ...
 * Parameters
 *
 * @ORM\Table(name="finance_gateways_parameters", indexes={@ORM\Index(name="gateway_id_index", columns={"gateway_id"})})
 * @ORM\Entity
