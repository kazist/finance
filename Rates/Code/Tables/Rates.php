...
namespace Finance\Rates\Code\Tables;
 ...
 * Rates
 *
 * @ORM\Table(name="finance_rates", indexes={@ORM\Index(name="country_id_index", columns={"country_id"}), @ORM\Index(name="created_by_index", columns={"created_by"}), @ORM\Index(name="modified_by_index", columns={"modified_by"})})
 * @ORM\Entity
